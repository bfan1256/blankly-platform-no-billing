...
const GeneralDetailsCard = ({projectId, modelId}: { projectId: string, modelId: string }) => {
  ...
  useEffect(() => {
    getModelOnce(projectId, modelId).then((res) => {
      const data = res.data();
        ...
        <div className="h-fit w-full relative bg-white rounded-lg border border-gray-200 mb-8">
          <div className="p-8 mb-16">
            ...
            <p className="my-2 text-gray-400">
              Model Name and ID are used to identify your model in the dashboard, CLI,
            ...
            submitted ?
              (
                <SuccessAlert message="Succesfully updated model details"/>
              )
              : null
          }
          ...
          <div
            ...
            <p className="text-gray-400 text-sm">Learn more about <a href="#" className="text-blue-500">Model Name
              and ID</a></p>
            <button type="submit"
