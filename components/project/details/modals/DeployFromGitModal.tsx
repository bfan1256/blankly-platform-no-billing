  ...
  return (
    <div className="container relative flex flex-col p-8 shadow-lg rounded-lg h-auto bg-white">
      ...
      <p className="inconsolate text-gray-500 text-sm w-4/5">
        ...
        for you. Check our <a href="" className="text-blue-500 hover:text-blue-600">limits</a> and
        <a href="" className="ml-1 text-blue-500 hover:text-blue-600">fair use policy</a>
      </p>
      <button
